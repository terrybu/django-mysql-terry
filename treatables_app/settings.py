"""
Django settings for treatables_app project.
...
SECRET_KEY = 'django-insecure-vl#nc-u@8)3@-rr0l&)q6n8x(h=5bt^1q5^%y$%&4ev%7-91^j'
...
LOGGING = {
    ...
    'loggers': {
        'django.db.backends': {
            'handlers': ['console'],
            'level': 'DEBUG', #instead of DEBUG which logs out SQL queries"
        },
    },
}
...
ROOT_URLCONF = 'treatables_app.urls'
...
WSGI_APPLICATION = 'treatables_app.wsgi.application'
